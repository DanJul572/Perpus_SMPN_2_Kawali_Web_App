                        ...
                        <table class="table table-head-bg-primary">
                            ...
                            <tbody>
                                <tr v-for="row in rows.data" :key="row.id">
                                    ...
                                    <td>
                                        <inertia-link :href="route('peminjaman.show', { siswa: row.id })" class="btn btn-round btn-xs btn-info">
...
export default {
    ...
    methods: {
        lists (page = 1) {
            ...
            this.$awn.asyncBlock(
                axios.get(route('peminjaman.lists') + '?page=' + page + '&keyword=' + filter.keyword + '&tingkat_id=' + filter.tingkat_id + '&kelas_id=' + filter.kelas_id),
                response => {
        ...
        formData () {
            this.$awn.asyncBlock(
                axios.get(route('peminjaman.form')),
                response => {
        ...
        async exportData () {
            const response = await axios.get(route('peminjaman.export'));
