            ...
            <div class="col-md">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div v-if="buku.length === 0" class="my-5">
                                ...
                                <table v-else class="table table-head-bg-primary mt-3">
                                    ...
                                    <tbody>
                                        <tr v-for="row in buku" :key="row.id">
...
export default {
    ...
    methods: {
        returned (peminjaman_id) {
            let onOk = () => {
                this.$awn.asyncBlock(
                    axios.post(route('peminjaman.returned', { siswa: this.siswa.id }), { peminjaman_id: peminjaman_id }),
                    () => {
                        let index = this.buku.findIndex(x => x.id == peminjaman_id);
